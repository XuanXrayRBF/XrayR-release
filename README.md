...
Find the source code here: [XuanXrayRBF/XrayR](https://github.com/XuanXrayRBF/XrayR)

# 详细使用教程

[教程](https://crackair.gitbook.io/XuanXrayRBF/)
...
```
1. `git clone https://github.com/XuanXrayRBF/XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
